...
$messages['qqq'] = array(
	...
	'apisb-no-js' => 'Used as error message in HTML <code><nowiki><noscript></nowiki></code> tag in [[Special:ApiSandbox]].',
	'apisb-intro' => 'Used as intro text in [[Special:ApiSandbox]].

This message is followed by the ApiSandbox form.',
	'apisb-api-disabled' => 'Used as error message in [[Special:ApiSandbox]].',
	'apisb-legend-parameters' => 'Used as fieldset label in [[Special:ApiSandbox]].
{{Identical|Parameter}}',
	'apisb-legend-result' => 'Used as fieldset label in [[Special:ApiSandbox]].

The fieldset contains read-only fields with info about an executed API request.
{{Identical|Result}}',
	'apisb-legend-generic-parameters' => 'Used as fieldset label in [[Special:ApiSandbox]].',
	'apisb-legend-generator-parameters' => 'Used as fieldset label in [[Special:ApiSandbox]].

Refers to an [[mw:API:Query#Generators|API concept]]',
...
{{Identical|Documentation}}',
	...
	'apisb-docs-more' => 'Used in parenthesis next to a short (but not cut off) version of the description.

Links to a page on mediawiki.org with complete documentation.
{{Identical|Read more}}',
...
{{Identical|Description}}',
	...
	'apisb-load-error' => 'Used as error message in [[Special:ApiSandbox]].',
	'apisb-request-error' => 'Used as error message in [[Special:ApiSandbox]].',
	'apisb-namespaces-error' => 'Unused at this time.

Used as error message when loading namespaces.',
...
{{Identical|Main}}',
	...
	'apisb-query-prop' => '{{Related|Apisb-query}}
{{Identical|Property}}',
	'apisb-query-list' => '{{Related|Apisb-query}}
{{Identical|List}}',
	'apisb-query-meta' => '{{Related|Apisb-query}}',
	...
	'apisb-examples' => 'Button text that will reveal the example list, used if the list contains multiple entries.

See also:
* {{msg-mw|apisb-example}}.
{{Identical|Example}}',
	'apisb-clear' => 'Title of the button that clears all inputs.
{{Identical|Clear}}',
	'apisb-request-time' => 'Parameters:
* $1 - time taken to process this request (in seconds)',
);
 ...
 */
$messages['af'] = array(
	'apisb-desc' => "Maak dit moontlik om [//www.mediawiki.org/wiki/API API-versoeke vir MediaWiki] vanuit 'n blaaier te ontfout",
	'apisandbox' => 'API-sandput',
	'apisb-no-js' => "'''Fout''': hierdie funksie vereis JavaScript.",
	'apisb-intro' => "Gebruik hierdie bladsy om te eksperimenteer met die '''MediaWiki-API'''.
Sien die [//www.mediawiki.org/wiki/API:Main_page API-dokumentasie] vir verdere details oor die gebruik van die API. Voorbeeld: [//www.mediawiki.org/wiki/API#A_simple_example hoe die inhoud van 'n Tuisblad te laai]. Kies 'n handeling om meer voorbeelde te sien.",
	...
	'apisb-legend-generator-parameters' => 'Generator',
	'apisb-result-request-url' => 'Versoek-URL:',
	'apisb-result-request-post' => 'POST-gegewens:',
	'apisb-label-format' => 'Formaat',
	'apisb-label-action' => 'Handeling',
	'apisb-label-doc' => 'Dokumentasie',
	'apisb-select-action' => "Kies 'n aksie",
	'apisb-select-query' => '(kies soekopdrag)',
	'apisb-select-value' => '(kies waarde)',
	...
	'apisb-namespaces-error' => 'Fout tydens laai van naamruimtes',
	...
	'apisb-clear' => 'Vee uit',
	'apisb-request-time' => 'Versoektyd: $1',
);
...
$messages['ar'] = array(
	...
	'apisb-result-request-post' => 'بيانات بوست:',
	...
	'apisb-clear' => 'إفراغ',
	'apisb-request-time' => 'وقت الطلب: $1',
);
 ...
 */
$messages['ba'] = array(
	'apisb-desc' => 'Браузерҙан мөрәжәғәттә яйға һала [//www.mediawiki.org/wiki/API MediaWiki API]',
	'apisandbox' => 'API һынау урыны',
	'apisb-no-js' => '"Хата". Бының өсөн JavaScript талап ителә.',
	'apisb-intro' => "''MediaWiki API''' өйрәнеү бите.  API ҡулланыу тураһында белешмә алыу өсөн [//www.mediawiki.org/wiki/API:Main_page API документацияһы]на мөрәжәғәт итегеҙ. Мәҫәләң, [//www.mediawiki.org/wiki/API#A_simple_example Башбит эстәлеген нисек алырға]. Башҡа миҫалдарҙы күреү өсөн ғәмәлде ҡулланығыҙ.",
	'apisb-api-disabled' => 'Был сайтта API һүндерелгән.',
	'apisb-legend-parameters' => 'Параметр',
	...
	'apisb-loading' => 'Асыла...',
	'apisb-load-error' => 'API тасуирламаһын тейәгәндә хата китте',
	'apisb-request-error' => 'API мөрәжәғәтен башҡарғанда хата китте',
	'apisb-namespaces-error' => 'Исемдәр арауығын тейәгәндә хата китте',
	'apisb-ns-main' => '(Төп)',
 ...
 */
$messages['bcl'] = array(
	'apisb-desc' => 'Minatugot na maghirog[//www.mediawiki.org/wiki/API MediaWiki API] nin mga apod gikan sa kilyawan',
	'apisandbox' => 'Kahong-buhangin kan API',
	'apisb-no-js' => "'''Kasalaan:''' ining hitsurahon nangangaipo nin JavaScript.",
	'apisb-intro' => "Gamitong ining pahina sa pag-eksperimento kan '''MediaWiki web service API'''.
Konsultaron an  [//www.mediawiki.org/wiki/API:Main_page the API documentation] para sa iba pang mga detalye sa paggamit kan API. Ehemplo: [//www.mediawiki.org/wiki/API#A_simple_example kuahon an laman kan Pangenot na Pahina]. Magpili nin aksyon tanganing hilngon an mga kadagdagan na mga ehemplo.",
	'apisb-api-disabled' => 'An API dae pinagpagana sa sityong ini.',
	'apisb-legend-parameters' => 'Mga parametro',
	'apisb-legend-result' => 'Resulta',
	'apisb-legend-generic-parameters' => 'Henerikong mga parametro',
	'apisb-legend-generator-parameters' => 'Parapuyos',
	'apisb-result-request-url' => 'Hagad URL:',
	'apisb-result-request-post' => 'Datos nin POST:',
	'apisb-label-format' => 'Pormat',
	'apisb-label-action' => 'Aksyon',
	'apisb-label-doc' => 'Dokumentasyon',
	'apisb-select-action' => '(pilion an aksyon)',
	'apisb-select-query' => '(pilion na kahaputan)',
	'apisb-select-value' => '(pilion an kahalagahaan)',
	'apisb-docs-more' => 'kadagdagan na basahon',
	'apisb-params-param' => 'Parametro',
	'apisb-params-input' => 'Panlaog',
	'apisb-params-desc' => 'Deskripsyon',
	'apisb-loading' => 'Ikinakarga...',
	'apisb-load-error' => 'Kasalaan sa pagkakarga kan API na deskripsyon',
	'apisb-request-error' => 'Kasalaan sa paghihimo kan API na kahagadan',
	'apisb-namespaces-error' => 'Kasalaan sa pagkakarga kan mga espasyong-ngaran',
	'apisb-ns-main' => '(Ginikanan)',
	'apisb-submit' => 'Maghimo nin kahagadan',
	'apisb-query-prop' => 'Mga Kagrugaring',
	'apisb-query-list' => 'Mga Listahan',
	'apisb-query-meta' => 'Impormasyong Meta',
	'apisb-example' => 'Ehemplo',
	'apisb-examples' => 'Mga ehemplo',
	'apisb-clear' => 'Klaro',
	'apisb-request-time' => 'Hagad oras:$1',
);
 ...
 */
$messages['ce'] = array(
	'apisb-intro' => "Лела йе хӀара агӀо '''MediaWiki API''' зуьйш.
API кхин муха лела йо хьажа [//www.mediawiki.org/wiki/API:Main_page кхузахь]. Масала, [//www.mediawiki.org/wiki/API#A_simple_example Коьрта агӀона чулацам схьаэца]. Кхин масалаш ган харжа дийриг.",
	'apisb-legend-parameters' => 'Параметраш',
	'apisb-legend-result' => 'Хилам',
	'apisb-legend-generic-parameters' => 'Юкъара параметраш',
	'apisb-result-request-url' => 'Дехаран URL-адрес:',
	'apisb-result-request-post' => 'POST хаамаш:',
	'apisb-label-action' => 'Дийраш',
	'apisb-label-doc' => 'Документаци',
	'apisb-select-action' => 'Харжа дийриг',
	'apisb-docs-more' => 'ма-дарра',
	'apisb-params-input' => 'Яздар',
	'apisb-params-desc' => 'Цуьнах лаьцна',
	'apisb-submit' => 'Дехар далар',
	'apisb-clear' => 'ЦӀанъян',
);
...
$messages['fo'] = array(
	...
	'apisb-no-js' => "'''Feilur:''' henda funksjónin krevur JavaScript.",
	'apisb-intro' => "Nýt hesa síðu til at royna teg við '''MediaWiki web service API'''.
	Víst verður til [//www.mediawiki.org/wiki/API:Main_page API documentasjónina] fyri smálutir um nýtslu av API. 
Dømi: [//www.mediawiki.org/wiki/API#A_simple_example fá innihaldið av einari Forsíðu].  Vel eina handling fyri at síggja fleiri dømi.",
	'apisb-api-disabled' => 'API er ikki virkið á hesi heimasíðuni.',
	'apisb-legend-result' => 'Úrslit',
	'apisb-result-request-url' => 'Bið um URL:',
	'apisb-label-format' => 'Slag (format)',
	'apisb-label-action' => 'Handling',
	'apisb-label-doc' => 'Dokumentasjón',
	'apisb-select-action' => '(vel handling)',
	'apisb-select-query' => '(vel fyrispurning)',
	'apisb-select-value' => '(vel virði)',
	'apisb-docs-more' => 'les meira',
	'apisb-params-desc' => 'Frágreiðing',
	'apisb-loading' => 'Løðir...',
	'apisb-load-error' => 'Ein feilur hendi, meðan API frágreiðing var innlisin',
	'apisb-request-error' => 'Feilur hendi meðan API fyrispurningur varð viðgjørdur',
	'apisb-namespaces-error' => 'Feilur undir innlesan av navnarúmum',
	'apisb-ns-main' => '(Høvuðs)',
	'apisb-submit' => 'Kom við fyrispurningi',
	'apisb-query-prop' => 'Eginleikar',
	'apisb-query-list' => 'Listar',
	'apisb-query-meta' => 'Meta kunning',
	'apisb-example' => 'Dømi',
	'apisb-examples' => 'Dømir',
	'apisb-clear' => 'Rudda',
	'apisb-request-time' => 'Fyrispurningurin tók so langa tíð: $1',
);
...
$messages['he'] = array(
	...
	'apisb-no-js' => "'''שגיאה''': אפשרות זו דורשת JavaScript",
...
$messages['hr'] = array(
	...
	'apisb-ns-main' => '(Glavni)',
	'apisb-submit' => 'Napraviti zahtjev',
	'apisb-query-prop' => 'Svojstva',
	'apisb-query-list' => 'Popisi',
	'apisb-example' => 'Primjer',
	'apisb-examples' => 'Primjeri',
	'apisb-clear' => 'Očisti',
);
...
$messages['id'] = array(
	...
	'apisb-intro' => "Gunakan halaman ini untuk bereksperimen dengan '''API layanan web MediaWiki'''.
...
$messages['ja'] = array(
	...
	'apisb-no-js' => "'''エラー:''' この機能には JavaScript が必要です。",
	'apisb-intro' => "このページでは、'''MediaWiki ウェブサービス API''' を試用できます。
 ...
 */
$messages['km'] = array(
	'apisb-loading' => 'កំពុងផ្ទុក…',
	'apisb-load-error' => 'បញ្ហាក្នុងការផ្ទុកការពណ៌នា API',
	'apisb-request-error' => 'បញ្ហាក្នុងការបំពេញសំណើ API',
	'apisb-namespaces-error' => 'បញ្ហាក្នុងការផ្ទុកលំហឈ្មោះ',
	'apisb-ns-main' => '(ទូទៅ)',
	'apisb-submit' => 'ដាក់សំណើ',
	'apisb-query-prop' => 'លក្ខណៈសម្បត្តិ',
	'apisb-query-list' => 'បញ្ជី',
	'apisb-query-meta' => 'ព័ត៌មានមេតា',
	'apisb-example' => 'ឧទាហរណ៍',
	'apisb-examples' => 'ឧទាហរណ៍',
	'apisb-clear' => 'ជម្រះ',
	'apisb-request-time' => 'រយៈពេលធ្វើសំណើ៖ $1',
);
 ...
 */
$messages['ko'] = array(
	'apisb-desc' => '브라우저에서 [//www.mediawiki.org/wiki/API 미디어위키 API] 호출을 디버그할 수 있습니다',
	'apisandbox' => 'API 실험실',
...
사용법에 대해서는 [//www.mediawiki.org/wiki/API:Main_page API 사용법]을 참고해보십시오. 예시: [//www.mediawiki.org/wiki/API#A_simple_example 대문의 내용 요청하기]. 더 많은 예시를 보려면 동작을 선택하세요.",
	...
	'apisb-legend-generic-parameters' => '일반 변수',
...
Söhk ene {{int:Apisb-label-action}} uß, öm mieh Beishpell aanjezeisch ze krijje.",
	...
	'apisb-loading' => 'Ben aam Laade{{int:ellipsis}}',
...
$messages['lb'] = array(
	...
	'apisb-no-js' => "'''Feeler''': dës Funktioun brauch JavaScript",
	'apisb-api-disabled' => 'API ass op dësem Site ausgeschalt.',
	'apisb-legend-parameters' => 'Parameteren',
	'apisb-legend-result' => 'Resultat',
	'apisb-legend-generic-parameters' => 'Generesch Parameter',
	'apisb-legend-generator-parameters' => 'Generateur',
	...
	'apisb-select-query' => '(Ufro eraussichen)',
...
$messages['lt'] = array(
	...
	'apisb-legend-generic-parameters' => 'Bendri parametrai',
	...
	'apisb-select-query' => '(pasirinkite užklausą)',
	...
	'apisb-request-time' => 'Užklausos laikas: $1',
);
...
$messages['lv'] = array(
	...
	'apisb-params-param' => 'Parametrs',
	'apisb-params-desc' => 'Apraksts',
	'apisb-loading' => 'Ielādē…',
	'apisb-query-list' => 'Saraksti',
	'apisb-example' => 'Piemērs',
	'apisb-examples' => 'Piemēri',
	'apisb-clear' => 'Notīrīt',
	'apisb-request-time' => 'Pieprasījuma izpildes laiks: $1',
);
 ...
 */
$messages['mr'] = array(
	'apisb-desc' => '[//www.mediawiki.org/wiki/API मिडियाविकि एपीआय]च्या गणकदोष निवारण्याच्या, न्याहाळकामार्फत दिलेल्या हाकेस, परवानगी देते',
	'apisb-no-js' => "'''त्रूटी:'''या तोंडवळ्यास(फिचर) जावास्क्रिप्ट हवी.",
	'apisb-api-disabled' => 'या संकेतस्थळावर एपीआय अक्षम केला आहे.',
	'apisb-legend-parameters' => 'प्राचले',
	'apisb-legend-result' => 'निकाल',
	'apisb-legend-generic-parameters' => 'जेनेरिक पॅरामिटर्स',
	'apisb-legend-generator-parameters' => 'निर्माता',
	'apisb-result-request-url' => "'यूआरएल'ची विनंती करा:",
	'apisb-result-request-post' => 'मजकूर टाका:',
	'apisb-label-action' => 'क्रिया',
	'apisb-label-doc' => 'दस्ताएवजीकरण',
	'apisb-select-action' => '(क्रिया निवडा)',
	'apisb-select-query' => '(पृच्छा निवडा)',
	'apisb-select-value' => '(किंमत निवडा)',
	'apisb-docs-more' => 'अधिक वाचन',
	'apisb-params-param' => 'प्राचले',
	'apisb-params-input' => 'निविष्टी',
	'apisb-params-desc' => 'वर्णन',
	'apisb-loading' => 'प्रभारण करीत आहे',
	'apisb-load-error' => 'एपीआयचे विवरण प्रभारणात त्रूटी',
	'apisb-request-error' => 'एपीआय विनंती क्रियान्वयनात त्रूटी',
	'apisb-namespaces-error' => 'नामविश्वे प्रभारणात त्रूटी',
	'apisb-ns-main' => '(मुख्य)',
	'apisb-submit' => 'विनंती करा',
	'apisb-query-prop' => 'गुणधर्म',
	'apisb-query-list' => 'याद्या',
	'apisb-query-meta' => 'मेटाविषयक माहिती',
	'apisb-example' => 'उदाहरण',
	'apisb-examples' => 'उदाहरणे',
	'apisb-clear' => 'हटवा',
	'apisb-request-time' => 'विनंती वेळ:$1',
);
...
$messages['nds'] = array(
	...
	'apisb-legend-result' => 'Resultat',
	'apisb-label-format' => 'Format',
	'apisb-label-action' => 'Akschoon',
	'apisb-label-doc' => 'Dokumentatschoon',
	'apisb-params-param' => 'Parameter',
	'apisb-params-input' => 'Ingave',
	'apisb-params-desc' => 'Beschrieven',
	'apisb-loading' => 'Läädt…',
	'apisb-ns-main' => '(Hööft-)',
	'apisb-query-prop' => 'Egenschapen',
	'apisb-query-list' => 'Listen',
	'apisb-query-meta' => 'Metainformatschonen',
	'apisb-example' => 'Bispeel',
	'apisb-examples' => 'Bispelen',
);
 ...
 */
$messages['nn'] = array(
	'apisb-desc' => 'Tillèt feilsøking av [//www.mediawiki.org/wiki/API MediaWiki API]-kall frå nettlesaren',
	'apisandbox' => 'API-sandkasse',
...
$messages['oc'] = array(
	...
	'apisb-api-disabled' => 'API es desactivat sus aqueste site.',
	'apisb-legend-parameters' => 'Paramètres',
	'apisb-legend-result' => 'Resultat',
	'apisb-legend-generic-parameters' => 'Paramètres generics',
	'apisb-legend-generator-parameters' => 'Generador',
	'apisb-result-request-url' => 'Requèsta URL :',
	'apisb-result-request-post' => 'donadas POST :',
	'apisb-label-format' => 'Format',
	'apisb-label-action' => 'Accion',
	'apisb-label-doc' => 'Documentacion',
	'apisb-select-action' => '(seleccionar una accion)',
	'apisb-select-query' => '(causir la requèsta)',
	'apisb-select-value' => '(causir la valor)',
	'apisb-docs-more' => 'ne saber mai',
	'apisb-params-param' => 'Paramètre',
	'apisb-params-input' => 'Entrada',
	'apisb-params-desc' => 'Descripcion',
	'apisb-loading' => 'Cargament...',
	'apisb-request-error' => 'Error al moment de l’execucion d’una requèsta API',
	'apisb-ns-main' => '(Principal)',
	'apisb-submit' => 'Far la demanda',
	'apisb-query-prop' => 'Proprietats',
	'apisb-query-list' => 'Listas',
	'apisb-query-meta' => 'Mèta-informacion',
	'apisb-example' => 'Exemple',
	'apisb-examples' => 'Exemples',
	'apisb-clear' => 'Escafar',
	'apisb-request-time' => 'Durada de la demanda : $1',
);
...
Consulte a [//www.mediawiki.org/wiki/API:Main_page documentação da API] para informações sobre o uso da API. Exemplo: [//www.mediawiki.org/wiki/API#A_simple_example get the content of a Main Page]. Selecione um ação para ver mais exemplos.",
	'apisb-api-disabled' => 'A API está desativada neste site.',
	...
	'apisb-select-action' => 'Selecionar ação',
...
$messages['roa-tara'] = array(
	...
	'apisb-intro' => "Ause sta pàgene pe sperimendà cu le '''API de le web service pe MediaUicchi'''.
...
Esembie: [//www.mediawiki.org/wiki/API#A_simple_example pigghie 'u condenute d'a Pàgene Prengepàle]. Scacchie 'n'azione pe 'ndrucà otre esembie.",
	'apisb-api-disabled' => "API non g'è abbiletate sus a stu site.",
	'apisb-legend-parameters' => 'Parametre',
 ...
 */
$messages['sw'] = array(
	'apisb-desc' => 'Imakubali kueua [//www.mediawiki.org/wiki/API MediaWiki API] kutoka kwa kivinjari.',
...
$messages['ta'] = array(
	...
	'apisb-namespaces-error' => 'பெயர்வெளிகளை இறக்குவதில் பிழை',
...
$messages['ug-arab'] = array(
	'apisb-desc' => 'توركۆرگۈدىن [//www.mediawiki.org/wiki/API MediaWiki API] سازلاشنى چاقىرىشقا يول قويىدۇ',
	'apisandbox' => 'API قۇم ساندۇقى',
	'apisb-no-js' => "'''خاتا''': بۇ ئىقتىدار JavaScript نى تەلەپ قىلىدۇ",
	'apisb-intro' => "بۇ بەت ئارقىلىق '''MediaWiki تور مۇلازىمىتى ئەپ ئېغىزى (API)نى سىناڭ'''.
بۇ API نى ئىشلىتىشنىڭ تەپسىلاتىنى بىلمەكچى بولسىڭىز [//www.mediawiki.org/wiki/API:Main_page the API قوللانمىسى]نى كۆرۈڭ. مەسىلەن: [//www.mediawiki.org/wiki/API#A_simple_example مەلۇم ئاساسىي بەتنىڭ مەزمۇنىغا ئېرىشىش]، ئاندىن بىر مەشغۇلاتنى تاللاپ تېخىمۇ كۆپ ئۈلگە مىسالنى كۆرۈڭ.",
	'apisb-api-disabled' => 'مەزكۇر بېكەتتە API چەكلەندى.',
	'apisb-legend-parameters' => 'پارامېتىر',
	'apisb-legend-result' => 'نەتىجە',
	...
	'apisb-load-error' => 'API چۈشەندۈرۈشنى يۈكلەشتە خاتالىق كۆرۈلدى.',
	'apisb-request-error' => 'API ئىلتىماس ئىجرا قىلىش جەريانىدا خاتالىق كۆرۈلدى',
	'apisb-namespaces-error' => 'ئىسىم بوشلۇق يۈكلەش خاتا',
	'apisb-ns-main' => '(ئاساسىي)',
...
$messages['war'] = array(
	'apisb-legend-result' => 'Resulta',
	'apisb-query-list' => 'Mga listahan',
	'apisb-query-meta' => 'Impormasyon hiton meta',
	'apisb-example' => 'Pananglitan',
	'apisb-examples' => 'Mga pananglitan',
);
